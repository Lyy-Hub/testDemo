...
public class HttpUtil {
    ...
    private static String getParamString(Map<String, String> paramMap) {
        ...
        while (it2.hasNext()) {
            builder.append("&").append(it2.next()).append("=").append(it2.next());
        }
     ...
     * @throws Exception
     */
    public static String post(String urlStr, String paramString) throws Exception {
        HttpURLConnection conn = null;
    ...
    public static void main(String[] args) {
        try {
            ...
            String postResult = post("https://portal-api.coinmarketcap.com/v1/login", paramString);
